...
export declare class FlowGenerator extends Generator {
    ...
    graphqlRenderers: {
        ...
        GraphQLObjectType: (type: GraphQLObjectType<any, any> | GraphQLInterfaceType | GraphQLInputObjectType) => string;
        GraphQLInterfaceType: (type: GraphQLObjectType<any, any> | GraphQLInterfaceType | GraphQLInputObjectType) => string;
        GraphQLInputObjectType: (type: GraphQLObjectType<any, any> | GraphQLInterfaceType | GraphQLInputObjectType) => string;
